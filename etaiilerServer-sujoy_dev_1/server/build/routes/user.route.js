...
router.post('/userRegister', userController.userResgister); //route to create a new user

router.post('/userLogin', userController.userLogin); //route for generating otp

router.post('/userOtp', userController.userOtp); //route for generating otp
